	...
	<body>
		...
		<form class="form-horizontal" action="${pageContext.request.contextPath }/speaker/addSpeaker.action" method="post">
  			<div class="form-group">
    			...
    			<div class="col-md-8">
      				<input type="text" class="form-control" name="speakerName" placeholder="主讲人姓名">
    			</div>
  			</div>
  			<div class="form-group">
    			<label for="inputPassword3" class="col-md-2 control-label">职业</label>
    			<div class="col-sm-8">
      				<input type="text" class="form-control" name="speakerJob" placeholder="主讲人职业">
    			</div>
  			</div>
  			<div class="form-group">
    			<label for="inputPassword3" class="col-md-2 control-label">头像图片</label>
    			<div class="col-sm-8">
      				<input type="text" class="form-control" name="speakerHeadUrl" placeholder="主讲人头像图片,网络地址">
    			</div>
  			</div>
